...
RESEND_API_KEY = get_env("RESEND_API_KEY", "UNISENDER_API_KEY", "MAILINFRA_API_KEY")
RESEND_API_URL = get_env("RESEND_API_URL", default="https://api.resend.com/emails")
EMAIL_SENDER_NAME = get_env("EMAIL_SENDER_NAME", default="Audit Advisor")
EMAIL_API_TIMEOUT = int(get_env("EMAIL_API_TIMEOUT", default="30"))
...
TELEGRAM_PROXY_URL = get_env("TELEGRAM_PROXY_URL", "HTTPS_PROXY", "HTTP_PROXY", "ALL_PROXY")
